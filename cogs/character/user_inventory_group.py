...
from cogs.store.store_utils import get_user_inventory, remove_item_from_inventory, get_item_by_id
...
class UserInventoryGroup(commands.Cog):
    def __init__(self, bot):
        self.bot = bot
        self.user_group = app_commands.Group(name="user", description="Manage your inventory and items")

        @self.user_group.command(name="inventory", description="👤 - 🎒 View your current inventory and equipped items")
        ...
        @self.user_group.command(name="unequip", description="👤 - ❌📦 Unequip an item by name")
        ...
        @self.user_group.command(name="equip", description="👤 - ✅📦 Equip an item by name")
        ...
        @self.user_group.command(name="gift", description="👤 - 🎁 Gift an item to another user")
...
async def setup(bot):
    ...
    bot.tree.add_command(cog.user_group)
